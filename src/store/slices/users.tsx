...
type UserState = {
  loading: boolean;
  loginError: object | undefined;
  signUpError: object | undefined;
...
const userSlice = createSlice({
  ...
  extraReducers: (builder) => {
    builder.addCase(loginUserAPI.pending, (state, { meta }) => {
      state.loading = true;
    });
    ...
    builder.addCase(loginUserAPI.rejected, (state, action) => {
      state.loginError = { status: 400, message: action.payload };
      state.loading = false;
    });
    builder.addCase(signUpUserAPI.pending, (state, { meta }) => {
      state.loading = true;
    });
    ...
    builder.addCase(signUpUserAPI.rejected, (state, action) => {
      state.signUpError = { status: 400, message: action.payload };
      state.loading = false;
    });
  },
});
